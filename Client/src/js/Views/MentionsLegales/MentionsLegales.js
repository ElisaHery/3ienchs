      ...
      <Fragment>
        ...
        <section id="MentionsLegalesWrap">
          ...
          <p className="p_justify">
            ...
            <a href="http://www.3ienchs.com" target="_blank">
              www.3ienchs.com
            </a>{" "}
          ...
          <p className="p_justify">
            ...
            <br />
            Nom de la Société :<strong> Brasserie 3ienchs</strong>
            <br />
            Adresse :{" "}
            <strong>48 rue Elias Howe 94100 Saint-Maur-des-Fossés</strong>
            <br />
            Tél  : <strong>0665469402</strong>
            <br />
            Au capital de :<strong> 5000 €</strong>
            <br />
            SIRET :  <strong>83879869200011   </strong>R.C.S. :
            <strong> CRETEIL</strong>
            <br />
            Numéro TVA intracommunautaire : <strong>FR 69 838798692</strong>
            <br />
            Adresse de courrier électronique :{" "}
            <strong>contact@3ienchs.com</strong> <br />
             <br />
            Lea créatrice du site est : <strong>Elisa Hery</strong>
            <br />
            Le responsable de la  publication est :{" "}
            <strong>Brasserie 3ienchs</strong>
            <br />
            Contactez le responsable de la publication :{" "}
            <strong>contact@3ienchs.com</strong>
            <br />
            ...
            <br />
            Le webmaster est  :{" "}
            <strong>Thibault Buekenhout / Thomas Corbé</strong>
            <br />
            Contactez le Webmaster :{" "}
            <strong>
              <a href="mailto:contact@3ienchs.com?subject=Contact ï¿½ partir des mentions lï¿½gales via le site www.3ienchs.com">
                contact@3ienchs.com
              </a>
            </strong>
            <br />
            L’hébergeur du site est :{" "}
            <strong>ionos Montabaur 56410 Montabaur</strong>
            <br />
            <u>
          ...
          <p className="p_justify"> </p>

          <p className="p_justify">
            <strong>2. Description des services fournis :</strong>
            <br />
            <br />
            Le site{" "}
            <a href="http://www.3ienchs.com" target="_blank">
          ...
          <p className="p_justify">
            <strong>3. Propriété intellectuelle et contrefaçons :</strong>
          </p>
          ...
          <p className="p_justify">
            ...
            sur son ordinateur. Un cookie est un fichier de petite taille, qui
            ne permet pas l’identification de l’utilisateur, mais qui enregistre
          ...
          <p className="p_justify">
            ...
            par email : email du webmaster ou  en effectuant sa demande écrite
          ...
          <p className="p_justify">
            ...
            à le proprietaire du site et de ses droits permettrait la
          ...
          <p className="p_justify">
            Le site www.3ienchs.com est en conformité avec le RGPD voir notre
            politique RGPD  dk.
          </p>
